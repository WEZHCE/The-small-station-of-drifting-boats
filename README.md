...
**内容板块**
- 关于我 / 船舱日记（GUI 日历 + 红点标记录日期，近况与日记统一时间线，项目带仓库链接）/ 相册（九本板块相册：像素画集、捣鼓token、校园时光、船长的画 + 五本待填；主页面只陈列封面与简介，双击封面或点「翻开相册」在独立的 相册.EXE 窗口里查看全部图片；灯箱浏览，←→ 切换）/ 留言板（giscus + 全文搜索）
