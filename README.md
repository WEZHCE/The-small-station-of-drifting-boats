...
**内容板块**
- 关于我 / 船舱日记（GUI 日历 + 红点标记录日期，近况与日记统一时间线，项目带仓库链接）/ 相册（九本板块相册：像素画集、捣鼓token、校园时光、船长的画、摄影作品、生活碎片、九小回忆、神秘一高 + 一本待填；主页面只陈列封面与简介，双击封面或点「翻开相册」在独立的 相册.EXE 窗口里查看全部图片；灯箱浏览，←→ 切换）/ 留言板（giscus + 全文搜索）
...
└── docs/            截图与相册图片（campus 校园实拍 / yigao 神秘一高 / tokens 燃料账单 / art 船长的画 / photo 摄影作品 / life 生活碎片 / jx 九小回忆）
```
