...
**内容板块**
- 关于我 / 船舱日记（GUI 日历 + 红点标记录日期，近况与日记统一时间线，项目带仓库链接）/ 相册（九本板块相册：像素画集、捣鼓token、校园时光、船长的画、摄影作品、生活碎片、九小回忆、神秘一高、出去玩；主页面只陈列封面与简介，双击封面或点「翻开相册」在独立的 相册.EXE 窗口里查看全部图片；灯箱浏览，←→ 切换）/ 留言板（giscus + 全文搜索）
- 漂流瓶：一键从留言里随机捞一条陌生人的话
- 左下角三块面板：甲板音乐（像素频谱播放器，已上架十四首——初音ミク / 镜音铃 / 重音テト / GUMI / 洛天依等 VOCALOID，加上 Something Just Like This / See You Again /《玲音》OP Duvet 等英文歌与动漫主题曲，开站随机播放）+ 船长状态（课表驱动的状态灯：地点 / 事情 / 心情，住校与假期自动切换）+ 灵动岛（实时显示游客正在浏览的板块 / 打开的应用 / 挂机状态，记录本次上船时长）
